...
const sample2_service_1 = __importDefault(require("../services/sample2.service"));
const app_config_1 = require("../config/app_config");
class Sample2Controller {
    constructor() {
        this.sampleService = new sample2_service_1.default();
        this.sampleTwoController = async (req, res) => {
            let response;
            let httpCode;
            try {
...
exports.default = Sample2Controller;
